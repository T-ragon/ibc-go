...
func (suite *LongTestSuite) SetupTest() {
...
func getBothSigners(suite *LongTestSuite, altVal *cmttypes.Validator, altPrivVal cmttypes.PrivValidator) (*cmttypes.ValidatorSet, map[string]cmttypes.PrivValidator) {
...
func TestLongTestSuite(t *testing.T) {
	testifysuite.Run(t, new(LongTestSuite))
}
